...
% big H param inside table and figures
\usepackage{float}

% bibliography using biber
\usepackage[backend=biber,style=alphabetic,sorting=ynt]{biblatex}
\addbibresource{content/99-appendix/bibliography.bib}
...
\input{content/99-appendix/glossary.tex}
\input{content/99-appendix/abbreviations.tex}